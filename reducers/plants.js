...
const reducer = handleActions(
  {
    ...
    [types.PLANT_ADD_SUCCESS]: (state, action) => addItem(state, action.payload.plant),
    ...
    [types.PLANT_DELETE_SUCCESS]: (state, action) => deleteItems(state, action.payload.ids),
    [types.PLANT_DELETE_FAILURE]: (state, action) => ({
      ...state,
      error: action.payload.error,
    }),
    
    [types.PLANT_EDIT_SUCCESS]: (state, action) => editItem(state, action.payload.plant),
